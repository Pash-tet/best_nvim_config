...
-- Быстрый выход из insert mode: jj → Esc. Две "j" подряд практически не
-- встречаются ни в коде, ни в тексте, поэтому ложные срабатывания редки, а
-- палец остаётся на home row — тянуться к Esc не нужно.
-- Известная альтернатива — "jk" (две буквы разными пальцами, ещё меньше
-- шансов напечатать случайно); выбран "jj" как более простой в наборе.
